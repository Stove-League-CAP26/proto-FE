...
export default function PlayerSearchBar({
  ...
  const inputEl = (width: string) => (
    <input
      ...
      placeholder={compact ? "선수 이름 입력" : "선수 이름 입력 (예: 양현종, 양의지)"}
        ...
        <div className="max-w-6xl mx-auto flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-400 hidden sm:block">
              현재: <span className="font-bold text-gray-600">{currentPlayerName}</span>
            </span>
            {heroAccent && (
              <span className="text-xs font-bold px-2 py-0.5 rounded-full text-white" style={{ backgroundColor: heroAccent }}>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-sm text-gray-400">이름을 입력하면 Statcast 스타일 프로필을 확인할 수 있어요</p>
